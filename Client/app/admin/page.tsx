        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-background/10">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-accent flex items-center justify-center text-accent-foreground font-semibold shrink-0 uppercase">
                {adminName.charAt(0)}
              </div>
              <div className="flex-1 min-w-0">
                <p className="font-medium text-sm truncate">{adminName}</p>
                <p className="text-xs text-background/50 truncate">{adminEmail}</p>
              </div>
              <Button 
                variant="ghost" 
                size="icon" 
